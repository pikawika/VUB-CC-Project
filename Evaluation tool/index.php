...
?>
    <div class="p-5 mb-4 bg-grey text-white">
        <h1 class="mb-4">Car design survey</h1>

        <p class="mb-2">Hello!</p>

        <p class="mb-2">Thanks for your interest in helping me, Lennert Bontinck, evaluate car designs.</p>
        ...
        <ul>
            ...
            <li>
                The answers you've given during the survey
            </li>
        </ul>
        </p>
